...
class GPUData(BaseModel):
	...
	memory_usage: float = Field(..., ge=0, le=100, description="GPU memory usage percentage")
	power_usage: Optional[float] = Field(None, description="GPU power usage in watts")
	fan_speed: Optional[float] = Field(None, ge=0, le=100, description="GPU fan speed percentage")
...
class AlertThreshold(BaseModel):
	...
	comparison: str = Field("greater", description="Comparison operator (greater, less)")
